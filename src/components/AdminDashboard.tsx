...
import { ShoppingBag, DollarSign, Calendar, Users, Clock, ChevronDown, ChevronRight, Undo2, Trophy, Store, Package, TrendingUp, Pencil, Save, X } from 'lucide-react';
                  ...
                  return (
                    <Fragment key={op.id}>
                      <tr onClick={() => setExpandedOperatorId(isExpanded ? null : op.id)} className="border-b border-slate-50 hover:bg-slate-50 transition-colors cursor-pointer">
                        ...
                        <td className="px-5 py-3 text-right font-semibold text-amber-600">R$ {formatBRL(k.emAberto.value)}</td>
